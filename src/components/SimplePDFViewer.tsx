...
import { ChevronLeft, ChevronRight, ZoomIn, ZoomOut, Download, Home, RotateCw } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="bg-white shadow-sm p-4 flex items-center justify-between border-b">
        ...
        <div className="flex items-center space-x-2">
          <Button onClick={zoomOut} variant="ghost" size="sm" disabled={scale <= 0.5}>
            <ZoomOut className="h-4 w-4" />
          </Button>
          <span className="text-sm px-2 min-w-[60px] text-center">{Math.round(scale * 100)}%</span>
          <Button onClick={zoomIn} variant="ghost" size="sm" disabled={scale >= 3}>
